...
export default function MaintenanceWorkScreen({ recordId, onGoBack }: Props) {
  ...
  const handleSubmit = () => {
    setSubmitting(true);
    // TODO: API call ke POST /api/maintenance-record/maintenance-records/{recordId}/complete
    setTimeout(() => {
      setSubmitting(false);
      setComplete(false);
    ...
    >
      ...
      <View style={[headerStyles.wrap, { paddingTop: insets.top + 8 }]}>
        ...
        <View style={headerStyles.topRow}>
          <TouchableOpacity style={headerStyles.backBtn} onPress={onGoBack} activeOpacity={0.8}>
